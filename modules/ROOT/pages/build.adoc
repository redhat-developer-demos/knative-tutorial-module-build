...
You can get one for free at https://quay.io[Quay]
====
...
include::knative-tutorial:ROOT:partial$build-env-vars.adoc[]
...
=== build 
include::knative-tutorial:ROOT:partial$knative-objects.adoc[tag=knative-build]
...
[#build-watching-logs]
== Watching logs
include::knative-tutorial:ROOT:partial$watching-build-logs.adoc[]
...
NOTE: You can also delete xref:knative-tutorial-build:ROOT:{build-repo}/build.adoc#build-apply-prereq-resources[pre-req resources] that were created if you don't need them anymore.
